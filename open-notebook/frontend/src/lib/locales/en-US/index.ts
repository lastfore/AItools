export const enUS = {
  ...
  sources: {
    ...
    webSearchDesc: "Search the web with SearXNG, pick URLs, then add them as link sources to your notebook.",
    webSearchStepSearch: "Search the web",
    webSearchStepSearchDesc: "Enter keywords and optional filters.",
    webSearchStepResults: "Pick URLs",
    webSearchStepResultsDesc: "Select which pages to add as sources (max 50).",
    webSearchKeywords: "Keywords",
    webSearchKeywordsPlaceholder: "e.g. transformer architecture survey",
    webSearchLanguage: "Language (optional)",
    webSearchCategories: "Categories",
    webSearchTimeRange: "Time range",
    webSearchTimeRangeAny: "Any time",
    webSearchTimeRangeDay: "Past day",
    webSearchTimeRangeMonth: "Past month",
    webSearchTimeRangeYear: "Past year",
    webSearchSafeSearch: "Safe search",
    webSearchLlmRanking: "LLM relevance ranking",
    webSearchLlmRankingHint: "Uses your default chat model to score results (may use API quota).",
    webSearchRun: "Search",
    webSearchSearching: "Searching…",
    webSearchStats: "Raw {raw} · After filters {filtered} · Showing {returned}",
    webSearchSelectAll: "Select all (up to 50)",
    webSearchDeselectAll: "Deselect all",
    webSearchSelectedCount: "{count} selected",
    webSearchNoResults: "No results to show.",
    webSearchPickOne: "Select at least one URL.",
    webSearchMaxSelected: "You can select at most {max} URLs per batch.",
    webSearchEngine: "Engine",
    webSearchScore: "Score",
    webSearchAddSelected: "Add selected",
    webSearchFailed: "Web search failed.",
    webSearchQueryRequired: "Enter keywords to search.",
    webSearchLlmApplied: "LLM ranking applied",
  },
  chat: {
    sessions: "Sessions",
