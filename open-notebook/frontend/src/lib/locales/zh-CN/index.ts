export const zhCN = {
  ...
  sources: {
    ...
    webSearch: "关键词搜索网页",
    webSearchDesc: "通过 SearXNG 搜索互联网，勾选 URL，再作为链接来源加入笔记本。",
    webSearchStepSearch: "搜索网页",
    webSearchStepSearchDesc: "输入关键词与可选筛选条件。",
    webSearchStepResults: "选择链接",
    webSearchStepResultsDesc: "选择要添加为来源的页面（最多 50 个）。",
    webSearchKeywords: "关键词",
    webSearchKeywordsPlaceholder: "例如：transformer 综述",
    webSearchLanguage: "语言（可选）",
    webSearchCategories: "分类",
    webSearchTimeRange: "时间范围",
    webSearchTimeRangeAny: "不限",
    webSearchTimeRangeDay: "过去一天",
    webSearchTimeRangeMonth: "过去一月",
    webSearchTimeRangeYear: "过去一年",
    webSearchSafeSearch: "安全搜索",
    webSearchLlmRanking: "大模型相关性排序",
    webSearchLlmRankingHint: "使用默认对话模型为结果打分（可能消耗 API 额度）。",
    webSearchRun: "搜索",
    webSearchSearching: "正在搜索…",
    webSearchStats: "原始 {raw} 条 · 筛选后 {filtered} 条 · 展示 {returned} 条",
    webSearchSelectAll: "全选（最多 50）",
    webSearchDeselectAll: "取消全选",
    webSearchSelectedCount: "已选 {count} 个",
    webSearchNoResults: "没有可显示的结果。",
    webSearchPickOne: "请至少选择一个 URL。",
    webSearchMaxSelected: "每批最多选择 {max} 个 URL。",
    webSearchEngine: "引擎",
    webSearchScore: "得分",
    webSearchAddSelected: "添加所选",
    webSearchFailed: "网页搜索失败。",
    webSearchQueryRequired: "请输入关键词。",
    webSearchLlmApplied: "已应用大模型排序",
  },
  chat: {
    sessions: "会话",
