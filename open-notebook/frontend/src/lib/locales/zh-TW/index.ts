export const zhTW = {
  ...
  sources: {
    ...
    webSearch: "關鍵字搜尋網頁",
    webSearchDesc: "透過 SearXNG 搜尋網際網路，勾選 URL，再作為連結來源加入筆記本。",
    webSearchStepSearch: "搜尋網頁",
    webSearchStepSearchDesc: "輸入關鍵字與可選篩選條件。",
    webSearchStepResults: "選擇連結",
    webSearchStepResultsDesc: "選擇要新增為來源的頁面（最多 50 個）。",
    webSearchKeywords: "關鍵字",
    webSearchKeywordsPlaceholder: "例如：transformer 綜述",
    webSearchLanguage: "語言（選填）",
    webSearchCategories: "分類",
    webSearchTimeRange: "時間範圍",
    webSearchTimeRangeAny: "不限",
    webSearchTimeRangeDay: "過去一天",
    webSearchTimeRangeMonth: "過去一個月",
    webSearchTimeRangeYear: "過去一年",
    webSearchSafeSearch: "安全搜尋",
    webSearchLlmRanking: "大模型相關性排序",
    webSearchLlmRankingHint: "使用預設對話模型為結果評分（可能消耗 API 額度）。",
    webSearchRun: "搜尋",
    webSearchSearching: "正在搜尋…",
    webSearchStats: "原始 {raw} 筆 · 篩選後 {filtered} 筆 · 顯示 {returned} 筆",
    webSearchSelectAll: "全選（最多 50）",
    webSearchDeselectAll: "取消全選",
    webSearchSelectedCount: "已選 {count} 個",
    webSearchNoResults: "沒有可顯示的結果。",
    webSearchPickOne: "請至少選擇一個 URL。",
    webSearchMaxSelected: "每批最多選擇 {max} 個 URL。",
    webSearchEngine: "引擎",
    webSearchScore: "得分",
    webSearchAddSelected: "新增所選",
    webSearchFailed: "網頁搜尋失敗。",
    webSearchQueryRequired: "請輸入關鍵字。",
    webSearchLlmApplied: "已套用大模型排序",
  },
  chat: {
    sessions: "對話",
